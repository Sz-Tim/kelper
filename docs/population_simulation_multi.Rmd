...
mass.sum.sf %>%
  ...
  geom_sf(colour=NA) + scale_fill_viridis_c() +
  facet_wrap(~year, ncol=10) +
  ggtitle(paste0("January stipe mass (", params$depth, "m)"))
mass.sum.sf %>%
  filter(month==1) %>% filter(year > 4) %>%
  ggplot(aes(fill=stipeMass+frondMass)) + 
  geom_sf(colour=NA) + scale_fill_viridis_c() +
  facet_wrap(~year, ncol=10) +
...
mass.sum.sf %>%
  ...
  geom_sf(colour=NA) + scale_fill_viridis_c() +
  facet_wrap(~year, ncol=10) +
  ggtitle(paste0("June stipe mass (", params$depth, "m)"))
mass.sum.sf %>%
  filter(month==6) %>% filter(year > 4) %>%
  ggplot(aes(fill=stipeMass+frondMass)) + 
  geom_sf(colour=NA) + scale_fill_viridis_c() +
  facet_wrap(~year, ncol=10) +
  ggtitle(paste0("June biomass (", params$depth, "m)"))
mass.sum.sf %>%
  filter(month==6) %>% filter(year > 4) %>%
  ggplot(aes(fill=stipe_q90-stipe_q10)) + 
  geom_sf(colour=NA) + scale_fill_viridis_c() +
  facet_wrap(~year, ncol=10) +
  ggtitle(paste0("June stipe mass CI width (", params$depth, "m)"))
